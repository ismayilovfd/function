...
//  1.ID-ə görə ölkəni tapan function yazın.
    ...
    //   let a = company.filter(item => item.id==f)

    //   console.log(a[0].shipAddress.country);
   ...
   // 2.Ölkəyə görə obyekti tapan function yazın.
    ...
    //   let a =company.filter(item => item.shipAddress.country=="u")
  ...
  //   let a =company.filter(item => item.id==d)

  //   console.log(a[0].shipAddress.city);

  //   console.log(a[0].shipAddress.country);

  //   console.log(a[0].shipName);
  // }
  ...
  // 4.ID-ə görə neçə növdə satış edildiyini göstərən function yazın. (details sayı)
      ...
      //   let a =company.filter(item => item.id==r)

      //   console.log(a[0].details.length);  
      //  }
...
//  5.ID-görə bir obyektin toplam qazancını tapan function yazın. (discount daxil)
    ...
    //   let a =company.filter(item => item.id==y)
    //   let b =(a[0].details[0].unitPrice)
    //   let c =(a[0].details[0].quantity)
    //   let d =(a[0].details[0].discount)
